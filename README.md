...
**(*)** Según la OSI (Open Source Initiative) técnicamente "Open Source" es un vocablo para ser usada únicamente por aquellas licencias de software que han sido submitidas al comité revisión de la OSI, debatida en la lista de revisión (y a veces también en la lista de discusión), y finalmente aprobadas por la OSI. Por otro lado, existen licencias de software que sus autores y administradores no se han interesado en subimitir la licencia a la OSI. Así por ejemplo, las licencias de software administradas por la FSF (Free Software Foundation) han sido reconocidas en forma unilateral por la OSI como licencias que cumplen con los requerimientos de la OSI para ser consideradas Open Source. En la práctica general, al menos en los proyectos de orden corporativos, tales proyectos que utilizan la palabra "open source" es para referirse a licencias de software que cumplen con los requisitos definidos por las FSF y la OSI. Lo que no es menos cierto, es que también existen otros casos en donde se utiliza el vocablo de "open source" para cierto tipo de licencias que en realidad no han sido reconocidas por la FSF (y por ende no se listan en su sitio de internet) ni han sido aprobadas por la OSI (sea porque no han sido reconocidas por la FSF, submitidas y aprobadas por la OSI, o sea porque su creador y administrador no lo entiende necesario, de hecho podrían existir varias razones adicionales objetivas o subjetivas)           
