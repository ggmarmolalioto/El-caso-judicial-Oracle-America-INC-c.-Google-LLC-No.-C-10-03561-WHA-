...
**(*)** Según la OSI (Open Source Initiative) técnicamente "Open Source" es un vocablo para ser usada únicamente por aquellas licencias de software que han sido submitidas al comité revisión de la OSI, debatida en la lista de revisión (y a veces también en la lista de discusión), y finalmente aprobadas por la OSI. Por otro lado, existen licencias de software que sus autores y administradores no se han interesado en subimitir la licencia a la OSI. Así por ejemplo, las licencias de software administradas por la FSF (Free Software Foundation) han sido reconocidas en forma unilateral por la OSI como licencias que cumplen con los requerimientos de la OSI para ser consideradas Open Source. En la práctica general, al menos en los proyectos de orden corporativos, tales proyectos que utilizan la palabra "open source" es para referirse a licencias de software que cumplen con los requisitos definidos por las FSF y la OSI. Lo que no es menos cierto, es que también existen otros casos en donde se utiliza el vocablo de "open source" para cierto tipo de licencias que en realidad no han sido reconocidas por la FSF -como licencias de software que cumplen con las 4 libertades que promueve la FSF- (y por ende no se listan en su sitio de internet) ni han sido reconocidas por la OSI -porque no cumplen con la definición de open source dada por la OSI-(sea porque han sido submitidas y no aprobadas por la OSI). Por último, existen licencias que su creador y administrador no entiende necesario tal reconocimiento de parte de la FSF o de la OSI, o que han sido rechazadas por la OSI y que de todas maneras cierto grupo las denomina como licencias open source.           
...
La dirección a donde puede remitirse el acuerdo es: gustavoguillermo.marmol at esade dot edu
